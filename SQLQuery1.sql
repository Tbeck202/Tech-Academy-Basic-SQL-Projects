...
BEGIN
	...
	INSERT INTO tbl_habitat
		...
		('icy aqauarium with snowy facade', 50000),
	...
	INSERT INTO tbl_specialist
		...
		VALUES
		('margret', 'nyguen', '111-111-1111'),
		('mary', 'fischer', '222-222-2222'),
		('arnold', 'holden', '333-333-3333'),
		('kem', 'byesan', '444-444-4444'),
		('delmonte', 'fyedo', '555-555-5555')
	;
	...
	INSERT INTO tbl_species
		...
		('chicken', 1, 100, 3, 5001, 2202, 'care_0'),
